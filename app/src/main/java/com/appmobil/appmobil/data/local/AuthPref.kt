package com.appmobil.appmobil.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appmobil.appmobil.data.model.ActionState
import com.appmobil.appmobil.data.model.AuthUser
import com.appmobil.appmobil.util.getObject
import com.appmobil.appmobil.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun  login(email: String, password: String): ActionState<AuthUser> {
        ...
        return if (user == null) {
            ...
            ActionState(message ="Email Tidak Boleh Kosong", isSuccsess = false )
